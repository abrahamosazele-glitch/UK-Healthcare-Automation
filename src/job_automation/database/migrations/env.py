...
# (required for autogenerate to see them) and resolves their string-based
# relationship() targets across files.
...
# Use the app's own settings (env vars / .env) as the source of truth for the
# DB URL, instead of the static value in alembic.ini.
